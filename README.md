...
The datas needed for this project where gathered from the available API from Twitter using Python and JSON (Python code is availabe [here](https://github.com/Dorigh/Global-warming/blob/master/tweet.py)). This data contains
